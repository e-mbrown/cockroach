...
MISC_SRCS = [
    ...
    "//pkg/sql/plpgsql/parser/plpgsqllexbase:keywords.go",
    "//pkg/sql/plpgsql/parser/plpgsqllexbase:reserved_keywords.go",
    "//pkg/sql/plpgsql/parser/plpgsqllexbase:tokens.go",
